    ...
    public class SalaDAO
    {
        ...
        public List<Sala> ListarTodos()
        {
            ...
            while (leitor.Read())
            {
                ...
                sala.Cspscidade = DAOHelper.GetString(leitor, "capacidade_sala");
                sala.Disponibilidade = DAOHelper.GetString(leitor, "disponibilade_sala)");
        ...
        public void Inserir(Sala sala)
        {
            try
            {
                var comando = _conexao.CreateCommand("INSERT INTO sala VALUES (@_id, @_numero, @_tipo, @_observacao, @_capacidade, @_disponibilidade)");
                ...
                comando.Parameters.AddWithValue("@_capacidade", sala.Cspscidade);
